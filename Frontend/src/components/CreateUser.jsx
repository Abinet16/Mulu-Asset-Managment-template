...
const EditUsers = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const url = isEditing ? `${API_BASE}/api/admin/users/${userId}` : `${API_BASE}/api/admin/users`;
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-2xl mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 极速 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </div>
                ...
                <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            {/* Department */}
                            <div>
                                <label htmlFor="department" className="block text-sm极速 font-medium text-gray-700 mb-1">
                                    Department *
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    value={userData.role}
                                    onChange={handleInputChange}
                                    className="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500极速 focus:border-blue-500 sm:text-sm"
                                    required
                                >
                            ...
                            {(!isEditing || userData.password) && (
                                <div className="sm:col-span-2">
                                    ...
                                    <input
                                        ...
                                        required={!isEditing || userData.password}
                                    />
